...
- Team accounts see a clear banner while the event has not started (or is paused). When the circuit is completed or the organizer ends the event, a one-time results dialog shows the final rank/top-three status, links to standings, and lets the team return to the start screen.
